# Lagrapport — Kävlinge HK F14

> Lagenkät · Säsongen 2025/26 · Maj 2026. Sammanställning av enkätsvar från Kävlinge HK F14 — 17 svar av 18 spelare. Genomsnittlig stämning per fråga, avvikelser värda att uppmärksamma, och rösterna bakom siffrorna.
>
...
| | Värde |
|---|---|
| Trivs mycket eller ganska bra | 94% |
| Vill spela nästa säsong | 100% |
| Nöjda med sin position | 88% |
| Vill vara med i målvaktsteamet | 3 |

## TL;DR

**Stämningen i laget är riktigt god.** Nästan alla tjejer trivs mycket bra, har många kompisar och tycker att tränarna är rättvisa och snälla. Alla 17 vill spela vidare nästa säsong — det är så bra det kan bli.
...
## 01 · Trivsel & gemenskap

### Q1 · Hur trivs du i laget?

Skala: Mycket bra · Ganska bra · Inte så bra · Inte alls. **Snittstämning: 4,9/5.**
...
### Q2 · Har du kompisar i laget?

Alla 16 svarande har minst några kompisar — de flesta har många. **100% har kompisar.**
...
Den enda riktiga avvikelsen i hela enkäten — värd att fånga upp. **1 av 16 har känt sig utanför.**
...
### Q4 · Tycker du att träningarna är roliga?

Skala: Alltid · Ofta · Sällan · Aldrig. **Snittstämning: 4,6/5.**
...
### Q6 · Var kommer pressen ifrån?

Spelarna kunde markera flera källor. Resultatet är väldigt tydligt — **10 av 12 pekar på sig själva**.
...
T.ex. en missad passning eller ett bommat skott. **100% hanterar det sunt.**

| Svar | Antal |
|---|---|
| "Det spelar ingen roll, jag klarar det nästa gång." | 9 |
| "Lite jobbigt men släpper det fort." | 7 |
| "Tar det hårt / tänker på det länge" | 0 |
...
### Q8 · Behandlar tränarna alla rättvist?

Skala: Ja · Ibland · Nej. **Snittstämning: 4,8/5.**
...
### Q9 · Spelar du med F14 även nästa säsong?

Den viktigaste siffran i hela enkäten. **17/17 svarar ja, jag fortsätter absolut.**

Inte ett enda "kanske". Inte ett enda "nej". Hela laget vill spela vidare.

### Q10 · Är du nöjd med din position?

Skala: Ja (1) · Nej (0). Två lämnade frågan blank. **88% av de som svarat är nöjda.**
...
Inför nästa säsongs satsning på målvaktsträning. **3 av 16 svarar ja.**
...
### Vad spelarna tycker att de är bra på

peppa laget · försvar · vara snäll · skjuta hårt · passningar · spärra · låsa · stegisättning · bjuda in alla · linjespel · springa · ta hand om de som är ledsna

### Vad spelarna vill bli bättre på

försvar · finter · kullager · passningar · stega förbi · teknik · skott från kant · kondition · genombrott · anfall · använda benen i målet · målvakt
